...
def standaardprijs(afstandKM):
    ...
    """
    #Als de afstand groter dan 50 is dan betaal je 15 euro + 0,60 per KM
    if afstandKM > 50:
        return 15 + (0.60 * afstandKM)
    #Als de afstand kleiner dan 50 km is dan betaal je 0.80 per KM
    elif afstandKM <= 0:
        return 0
    else:
...
def ritprijs(leeftijd, weekendrit, afstandKM):
    ...
    """
    # Als de leeftijd kleiner is dan 12 of de leeftijd 65 of hoger is dan....
...
def development_code():
    # Plaats hieronder code om je functies tussentijds te testen. Bijvoorbeeld:
